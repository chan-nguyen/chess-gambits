...
| **Bundle budget has ~25% headroom with items still unbudgeted** — boundary validation, catalogue search, tree layout                                                                                                                                | Medium                         | Medium       | Dropping the board library recovered 21.9 KB. The budget becomes route-level, and boundary validation is hand-rolled rather than a schema library                                                                                                                             |
