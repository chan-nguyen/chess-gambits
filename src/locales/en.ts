...
const en: PartialTranslations = {
  ...
  home: {
    ...
    tryIntro:
      'Play a move on the board below — anything legal goes. The list filters to match exactly what you played.',
    undo: 'Undo',
    reset: 'Reset',
    playToFilter: 'Play a move on the board to see the gambits and traps that match it.',
    matchCount: '{{count}} matching',
    noMatch: 'No gambit or trap found.',
    continueIn: 'Continue in: {{name}}',
    movePlayed: 'Played {{san}}',
    checkmate: 'Checkmate.',
    stalemate: 'No legal move — stalemate.',
    draw: 'Draw.',
    choosePromotion: 'Choose a piece to promote to',
  },
  tree: {
