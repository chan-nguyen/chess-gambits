...
const en: PartialTranslations = {
  ...
  learn: {
    ...
    atStart: 'This is the starting position.',
    atRoot: 'This is the start of the line.',
    atEnd: 'This is the end of the line.',
    startingPosition: 'Starting position',
    gambitRoot: 'Start of the line',
    preludePly:
      'This move is one of the opening moves that reach the gambit. The teaching starts at the start of the line.',
    after: 'After',
  ...
  home: {
    ...
    tryHeading: 'Try a few moves',
    tryIntro: 'Play a move on the board below. The list filters to match exactly what you played.',
    undo: 'Undo',
    reset: 'Reset',
    boardLoading: 'Loading the opening tree…',
    boardUnavailable:
      'The opening tree could not be loaded, so moves cannot be tried here. The full catalogue is still available.',
    retry: 'Try again',
    retrying: 'Trying again…',
    playToFilter: 'Play a move on the board to see the gambits and traps that match it.',
    matchCount: '{{count}} matching',
    noMatch: 'No gambit or trap matches these moves.',
    continueIn: 'Continue in: {{name}}',
    movePlayed: 'Played {{san}}',
  },
  tree: {
