...
test.describe('every taught entry, from the catalogue to every leaf (AC 7)', () => {
  test('there are three hundred and fifty-eight of them, and they are the ones the content tickets authored', () => {
    expect(taught.map((entry) => entry.id).sort()).toEqual([
      'alekhine-defense-krejcik-variation-krejcik-gambit',
      'alekhine-defense-osullivan-gambit',
      ...
      'bird-opening-froms-gambit-bahr-gambit',
      ...
      'bishops-opening-lewis-countergambit',
      'bishops-opening-lewis-gambit',
      'bishops-opening-ponziani-gambit',
      'bishops-opening-stein-gambit',
      'bishops-opening-warsaw-gambit',
      ...
      'kings-gambit-accepted-ghulam-kassim-gambit',
      'kings-gambit-accepted-gianutio-countergambit',
      'kings-gambit-accepted-hanstein-gambit',
      'kings-gambit-accepted-kieseritzky-gambit',
      'kings-gambit-accepted-kieseritzky-gambit-berlin-defense',
      'kings-gambit-accepted-kieseritzky-gambit-brentano-defense',
      'kings-gambit-accepted-kieseritzky-gambit-kolisch-defense',
      'kings-gambit-accepted-kings-knights-gambit',
      'kings-gambit-accepted-macleod-defense',
      'kings-gambit-accepted-mason-keres-gambit',
      'kings-gambit-accepted-mayet-gambit',
      'kings-gambit-accepted-mcdonnell-gambit',
      'kings-gambit-accepted-modern-defense',
      'kings-gambit-accepted-muzio-gambit-wild-muzio-gambit',
      'kings-gambit-accepted-orsini-gambit',
      'kings-gambit-accepted-paris-gambit',
      'kings-gambit-accepted-philidor-gambit',
      'kings-gambit-accepted-philidor-gambit-schultz-variation',
      'kings-gambit-accepted-quaade-gambit',
      'kings-gambit-accepted-rosentreter-gambit',
      'kings-gambit-accepted-rosentreter-gambit-sorensen-gambit',
      ...
      'kings-gambit-accepted-sorensen-gambit',
      'kings-gambit-accepted-stamma-gambit',
      'kings-gambit-accepted-tartakower-gambit',
      'kings-gambit-accepted-tartakower-gambit-weiss-defense',
      ...
      'kings-gambit-declined-classical-hanham-variation',
      ...
      'kings-gambit-declined-falkbeer-countergambit-accepted',
      'kings-gambit-declined-falkbeer-countergambit-hinrichsen-gambit',
      'kings-gambit-declined-falkbeer-countergambit-modern-transfer',
      'kings-gambit-declined-falkbeer-countergambit-staunton-line',
      'kings-gambit-declined-hobbs-zilbermints-gambit',
      'kings-gambit-declined-keenes-defense',
      'kings-gambit-declined-mafia-defense',
      'kings-gambit-declined-norwalde-variation',
      'kings-gambit-declined-norwalde-variation-bucker-gambit',
      'kings-gambit-declined-norwalde-variation-schubert-variation',
      'kings-gambit-declined-panteldakis-countergambit',
      'kings-gambit-declined-panteldakis-countergambit-shirazi-line',
      'kings-gambit-declined-petrovs-defense',
      'kings-gambit-declined-queens-knight-defense',
      'kings-gambit-declined-zilbermints-double-countergambit',
      ...
      'kings-pawn-game-beyer-gambit',
      'kings-pawn-game-busch-gass-gambit',
      'kings-pawn-game-busch-gass-gambit-chiodini-gambit',
      'kings-pawn-game-clam-variation-kings-gambit-reversed',
      'kings-pawn-game-gunderam-defense-gunderam-gambit',
      'kings-pawn-game-gunderam-gambit',
      'kings-pawn-game-pachman-wing-gambit',
      'kings-pawn-game-philidor-gambit',
      'kings-pawn-game-schulze-muller-gambit',
      'kings-pawn-game-tayler-opening-basman-gambit',
      'kings-pawn-game-wayward-queen-attack-kiddie-countergambit',
      'kings-pawn-game-weber-gambit',
      ...
      'panov-attack-fianchetto-defense-fianchetto-gambit',
      'petrovs-defense-cochrane-gambit',
      'petrovs-defense-marshall-trap',
      'petrovs-defense-moody-gambit',
      'petrovs-defense-stafford-gambit',
      'petrovs-defense-stafford-gambit-accepted',
      ...
      'sicilian-defense-okelly-variation-normal-system-cortlever-gambit',
      ...
      'vant-kruijs-opening-keoni-hiva-gambit-alua-variation',
