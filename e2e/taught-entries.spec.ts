...
test.describe('every taught entry, from the catalogue to every leaf (AC 7)', () => {
  test('there are three hundred and fifty-eight of them, and they are the ones the content tickets authored', () => {
    expect(taught.map((entry) => entry.id).sort()).toEqual([
      ...
      'grunfeld-defense-brinckmann-attack-grunfeld-gambit-accepted',
      'grunfeld-defense-gibbon-gambit',
      'gunderam-defense-stader-variation',
      'halosar-trap',
      ...
      'kings-gambit-accepted-bishops-gambit-anderssen-variation',
      'kings-gambit-accepted-bishops-gambit-bledow-countergambit',
      'kings-gambit-accepted-bishops-gambit-bledow-variation',
      'kings-gambit-accepted-bishops-gambit-boden-variation',
      'kings-gambit-accepted-bishops-gambit-bogoljubow-variation',
      'kings-gambit-accepted-bishops-gambit-cozio-defense',
      'kings-gambit-accepted-bishops-gambit-cozio-variation',
      'kings-gambit-accepted-bishops-gambit-first-jaenisch-variation',
      ...
      'kings-gambit-accepted-bishops-gambit-lopez-variation',
