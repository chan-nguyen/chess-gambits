...
test.describe('every taught entry, from the catalogue to every leaf (AC 7)', () => {
  test('there are three hundred and five of them, and they are the ones the content tickets authored', () => {
    expect(taught.map((entry) => entry.id).sort()).toEqual([
      ...
      'benko-gambit-declined-hjorring-countergambit',
      'benko-gambit-declined-main-line',
      'benko-gambit-declined-pseudo-samisch',
      ...
      'bishops-opening-mcdonnell-gambit',
      'bishops-opening-mcdonnell-gambit-la-bourdonnais-denker-gambit',
      'bishops-opening-mcdonnell-gambit-mcdonnell-double-gambit',
      ...
      'budapest-gambit-accepted-fajarowicz-defense-bonsdorf-variation',
      'budapest-gambit-accepted-fajarowicz-defense-steiner-variation',
      'budapest-gambit-accepted-main-line-adler-variation',
      'budapest-gambit-accepted-main-line-alekhine-variation',
      'budapest-gambit-accepted-main-line-rubinstein-variation',
      ...
      'english-opening-anglo-scandinavian-defense-lohn-gambit',
      ...
      'falkbeer-countergambit-charousek-gambit-accepted',
      'fishing-pole-trap',
