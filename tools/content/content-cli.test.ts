...
describe('compile (AC 3)', () => {
  it('writes one minified JSON file per entry', () => {
    ...
    expect([...readdirSync(out)].sort()).toStrictEqual([
      ...
      'englund-gambit.json',
      'falkbeer-countergambit-charousek-gambit-old-line.json',
      'falkbeer-countergambit-milner-barry-variation.json',
      'falkbeer-countergambit-nimzowitsch-marshall-countergambit.json',
      'falkbeer-countergambit-rubinstein-variation.json',
      'fishing-pole-trap.json',
      'four-knights-game-halloween-gambit.json',
      'four-knights-game-italian-variation-noa-gambit.json',
      'four-knights-game-scotch-variation-belgrade-gambit.json',
      'four-knights-game-scotch-variation-krause-gambit.json',
      'french-defense-advance-variation-milner-barry-gambit.json',
      'french-defense-alapin-gambit.json',
      'french-defense-banzai-leong-gambit.json',
      'french-defense-carlson-gambit.json',
      'french-defense-diemer-duhm-gambit-accepted.json',
      'french-defense-diemer-duhm-gambit.json',
      'french-defense-marshall-gambit.json',
      'french-defense-morphy-gambit.json',
      'french-defense-wing-gambit.json',
      'grob-opening-alessi-gambit.json',
      'grob-opening-grob-gambit-basman-gambit.json',
      'grob-opening-grob-gambit-declined.json',
      'grob-opening-grob-gambit-fritz-gambit.json',
      'grob-opening-grob-gambit-richter-grob-gambit.json',
      'grob-opening-grob-gambit.json',
      'grob-opening-romford-countergambit.json',
      'grunfeld-defense-brinckmann-attack-grunfeld-gambit-accepted.json',
      'grunfeld-defense-gibbon-gambit.json',
      'gunderam-defense-stader-variation.json',
      'halosar-trap.json',
      'hamppe-allgaier-gambit-alapin-variation.json',
      'hamppe-allgaier-gambit-thorold-variation.json',
      'horwitz-defense-zilbermints-gambit.json',
      'hungarian-opening-asten-gambit.json',
      'hungarian-opening-bucker-gambit.json',
      'hungarian-opening-pachman-gambit.json',
      'hungarian-opening-van-kuijk-gambit.json',
      'hungarian-opening-winterberg-gambit.json',
      'indian-defense-anti-grunfeld-adorjan-gambit.json',
      'indian-defense-budapest-gambit-accepted-fajarowicz-defense.json',
      'indian-defense-budapest-gambit-accepted.json',
      'indian-defense-budapest-gambit.json',
      'indian-defense-gibbins-weidenhagen-gambit-accepted.json',
      'indian-defense-gibbins-weidenhagen-gambit-oshima-defense.json',
      'indian-defense-gibbins-weidenhagen-gambit.json',
      'indian-defense-lazard-gambit.json',
      'indian-defense-omega-gambit.json',
      'irish-gambit.json',
      'italian-game-blackburne-kostic-gambit.json',
      'italian-game-evans-gambit-accepted.json',
      'italian-game-evans-gambit-anderssen-variation.json',
      'italian-game-evans-gambit-declined.json',
      'italian-game-evans-gambit-fontaine-countergambit.json',
      'italian-game-evans-gambit-hein-countergambit.json',
      'italian-game-evans-gambit-main-line.json',
      'italian-game-evans-gambit-mayet-defense.json',
      'italian-game-evans-gambit-mcdonnell-defense.json',
      'italian-game-evans-gambit-stone-ware-variation.json',
      ...
      'italian-game-scotch-gambit.json',
      'italian-game-two-knights-defense-fried-liver-attack.json',
      'italian-game-two-knights-defense-traxler-counterattack.json',
      ...
      'kings-gambit-accepted-bishops-gambit-anderssen-variation.json',
      'kings-gambit-accepted-bishops-gambit-bledow-countergambit.json',
      'kings-gambit-accepted-bishops-gambit-bledow-variation.json',
      'kings-gambit-accepted-bishops-gambit-boden-variation.json',
      'kings-gambit-accepted-bishops-gambit-bogoljubow-variation.json',
      'kings-gambit-accepted-bishops-gambit-cozio-defense.json',
      'kings-gambit-accepted-bishops-gambit-cozio-variation.json',
      'kings-gambit-accepted-bishops-gambit-first-jaenisch-variation.json',
      'kings-gambit-accepted-bishops-gambit-gianutio-gambit.json',
      'kings-gambit-accepted-bishops-gambit-greco-variation.json',
      'kings-gambit-accepted-bishops-gambit-kieseritzky-gambit.json',
      'kings-gambit-accepted-bishops-gambit-lopez-defense.json',
      'kings-gambit-accepted-bishops-gambit-lopez-variation.json',
