...
describe('compile (AC 3)', () => {
  it('writes one minified JSON file per entry', () => {
    ...
    expect([...readdirSync(out)].sort()).toStrictEqual([
      'accelerated-london-system-steinitz-countergambit-accepted.json',
      'accelerated-london-system-steinitz-countergambit.json',
      ...
      'benko-gambit-declined-hjorring-countergambit.json',
      'benko-gambit-declined-main-line.json',
      'benko-gambit-declined-pseudo-samisch.json',
      'benko-gambit-declined-quiet-line.json',
      'benko-gambit-declined-sosonko-variation.json',
      'benko-gambit-fianchetto-variation.json',
      'benko-gambit-mutkin-countergambit.json',
      'benko-gambit.json',
      'benoni-defense-benoni-gambit-accepted.json',
      'benoni-defense-benoni-gambit-schlenker-defense.json',
      'benoni-defense-cormorant-gambit.json',
      'benoni-defense-zilbermints-benoni-gambit.json',
      ...
      'bird-opening-sturm-gambit.json',
      'bird-opening-wagner-zwitersch-gambit.json',
      'bird-opening-williams-gambit.json',
      ...
      'bishops-opening-mcdonnell-gambit-la-bourdonnais-denker-gambit.json',
      'bishops-opening-mcdonnell-gambit-mcdonnell-double-gambit.json',
      'bishops-opening-mcdonnell-gambit.json',
      'bishops-opening-ponziani-gambit.json',
      'bishops-opening-stein-gambit.json',
      'bishops-opening-urusov-gambit.json',
      'bishops-opening-warsaw-gambit.json',
      'blackmar-diemer-gambit-accepted-euwe-defense.json',
      'blackmar-diemer-gambit-accepted-ryder-gambit.json',
      ...
      'blackmar-diemer-gambit-diemer-rosenberg-attack.json',
      'blackmar-diemer-gambit-fritz-attack.json',
      'blackmar-diemer-gambit-lemberger-countergambit.json',
      'blackmar-diemer-gambit-reversed-albin-countergambit.json',
      'blackmar-diemer-gambit-zeller-defense.json',
      ...
      'budapest-gambit-accepted-fajarowicz-defense-bonsdorf-variation.json',
      'budapest-gambit-accepted-fajarowicz-defense-steiner-variation.json',
      'budapest-gambit-accepted-main-line-adler-variation.json',
      'budapest-gambit-accepted-main-line-alekhine-variation.json',
      'budapest-gambit-accepted-main-line-rubinstein-variation.json',
      'caro-kann-defense-alekhine-gambit.json',
      'caro-kann-defense-labahn-attack-double-gambit.json',
      'caro-kann-defense-mieses-gambit.json',
      'caro-kann-defense-von-hennig-gambit.json',
      'carr-defense-zilbermints-gambit.json',
      'catalan-opening-hungarian-gambit.json',
      'center-game-halasz-mcdonnell-gambit.json',
      'center-game-lanc-arnold-gambit.json',
      'center-game-ross-gambit.json',
      'center-game-von-der-lasa-gambit.json',
      'damiano-defence-refutation.json',
      'danish-gambit-accepted-chigorin-defense.json',
      'danish-gambit-accepted-classical-defense.json',
      'danish-gambit-accepted-copenhagen-defense.json',
      'danish-gambit-accepted-schlechter-defense.json',
      ...
      'dutch-defense-omega-isis-gambit.json',
      'dutch-defense-staunton-gambit-accepted.json',
      'dutch-defense-staunton-gambit-tartakower-variation.json',
      'dutch-defense-staunton-gambit.json',
      ...
      'english-opening-achilles-omega-gambit.json',
      'english-opening-anglo-dutch-defense-hickmann-gambit.json',
      'english-opening-anglo-scandinavian-defense-lohn-gambit.json',
      'english-opening-jaenisch-gambit.json',
      'english-opening-wade-gambit.json',
      'english-opening-wing-gambit.json',
      'englund-gambit-declined-reversed-alekhine.json',
      'englund-gambit-declined-reversed-french.json',
      'englund-gambit-declined-reversed-krebs.json',
      ...
      'englund-gambit-stockholm-variation.json',
      'englund-gambit-trap.json',
      'englund-gambit-zilbermints-gambit.json',
      'englund-gambit.json',
      'falkbeer-countergambit-charousek-gambit-accepted.json',
