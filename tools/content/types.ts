 ...
 *
 * Generated by the build, never hand-authored (invariant 4, ADR-0005). Nothing in this
 * package constructs one — issue #5 owns the prover. The shape exists here so that the
 * three outcomes stay three distinct types rather than collapsing into one shape with
 * optional fields, and so every exhaustive switch already has a place to put it.
 */
