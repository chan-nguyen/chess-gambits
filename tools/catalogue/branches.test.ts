...
describe('the catalogue this repository ships', () => {
  ...
  const AUTHORED: ReadonlyMap<string, number> = new Map([
    ...
    ['italian-game-rousseau-gambit', 0],
    ['kadas-opening-schneider-gambit', 1],
    ['kieninger-trap', 4],
    ['kings-gambit', 5],
    ['kings-gambit-accepted', 1],
    ['kings-gambit-accepted-becker-defense', 1],
    ['kings-gambit-accepted-bishops-gambit-anderssen-defense', 0],
    ['kings-gambit-accepted-bishops-gambit-bledow-variation', 0],
    ['kings-gambit-accepted-bishops-gambit-cozio-defense', 0],
    ['kings-gambit-accepted-bishops-gambit-gianutio-gambit', 0],
    ['kings-gambit-accepted-bishops-gambit-kieseritzky-gambit', 0],
    ['kings-gambit-accepted-bishops-gambit-lopez-defense', 0],
    ['kings-gambit-accepted-bishops-gambit-maurian-defense', 0],
    ['kings-gambit-accepted-bishops-gambit-steinitz-defense', 0],
    ['kings-gambit-accepted-bonsch-osmolovsky-variation', 0],
    ['kings-gambit-accepted-cunningham-defense', 0],
    ['kings-gambit-accepted-fischer-defense', 0],
    ['kings-gambit-accepted-gianutio-countergambit', 0],
    ['kings-gambit-accepted-macleod-defense', 0],
    ['kings-gambit-accepted-modern-defense', 0],
    ['kings-gambit-accepted-schallopp-defense', 0],
    ['kings-gambit-accepted-wagenbach-defense', 0],
